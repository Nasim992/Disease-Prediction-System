...
$username=$_SESSION["username"];
    $sql ="SELECT password FROM user WHERE user_name=:username and password=:password and password!=:newpassword";
...
if($query -> rowCount() > 0)
{
$con="update user set password=:newpassword where user_name=:username";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':username', $username, PDO::PARAM_STR);
$chngpwd1-> bindParam(':newpassword', $newpassword, PDO::PARAM_STR);
$chngpwd1->execute();
$msg="Your Password has changed succesfully ";
}
else {
$error="Your current password is wrong.or Your Old password is matched with new password";    
}
} 
?>
<!DOCTYPE html>
