...
if($query -> rowCount() > 0)
{
$con="update admin set UserName=:uname where UserName=:username";
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form  name="chngpwd" method="post" \ onSubmit="return valid();">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                    <input type="text" name="usname" class="form-control" required="required" id="success" placeholder="Username">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="password" name="password" required="required" class="form-control" id="success"placeholder="Password">
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
